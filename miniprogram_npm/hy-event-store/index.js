...
__DEFINE__(1677308626632, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1677308626633,"./event-store":1677308626634}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1677308626633, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1677308626634, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1677308626633,"./utils":1677308626635}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1677308626635, function(require, module, exports) {
...
return __REQUIRE__(1677308626632);
})()
